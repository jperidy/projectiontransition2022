...
<div class="px-5 py-3">
  ...
  <div class="row">
    ...
    <div class="col text-center">
      ...
      <img class="img-fluid mt-3" src={seo.FAVICON_48_48} alt="FAVICON_48_48" />
    </div>
    <div class="col text-center">
      ...
      <img class="img-fluid mt-3" src={seo.FAVICON_64_64} alt="FAVICON_64_64" />
    </div>
    <div class="col text-center">
      ...
      <img class="img-fluid mt-3" src={seo.FAVICON_96_96} alt="FAVICON_96_96" />
    </div>
    <div class="col text-center">
      ...
      <img class="img-fluid mt-3" src={seo.FAVICON_128_128} alt="FAVICON_128_128" />
    </div>
    <div class="col text-center">
      ...
      <img class="img-fluid mt-3" src={seo.FAVICON_196_196} alt="FAVICON_196_196" />
    </div>
  </div>
</div>